...
export default function LoginPage() {
  ...
  // Use env var for redirect, fallback to window.location.origin
    ...
    <div className="max-w-md mx-auto px-4 py-8 md:py-12">
      <div className="card">
        ...
        <div className="text-center mb-8">
          <h1 className="font-serif text-3xl font-bold text-primary-900 dark:text-dark-100 mb-1">
            MeraEhsaas
          </h1>
          <p className="text-sm text-primary-400 dark:text-dark-400">
            A quiet space for poetry, emotions, and stories
          </p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-warm-300 dark:border-dark-600 rounded-xl hover:bg-warm-50 dark:hover:bg-dark-700 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          aria-label="Sign in with Google"
        >
          {googleLoading ? (
            <svg className="w-5 h-5 animate-spin text-primary-400" viewBox="0 0 24 24" fill="none" aria-hidden="true">
          ...
          <span className="text-sm font-medium text-primary-700 dark:text-dark-200">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-white dark:bg-dark-800 px-3 text-primary-400 dark:text-dark-400">or</span>
          </div>
        </div>
        ...
        {mode === "password" && (
          <form onSubmit={handlePasswordLogin} className="space-y-4" noValidate>
            <div>
              <label htmlFor="login-email" className="block text-xs font-medium text-primary-600 dark:text-dark-300 mb-1">
                Email
              </label>
              <input
                id="login-email"
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label htmlFor="login-password" className="block text-xs font-medium text-primary-600 dark:text-dark-300">
                  Password
                </label>
        ...
        <p className="mt-6 text-center text-sm text-primary-500 dark:text-dark-400">
          ...
          <Link href="/signup" className="text-accent-600 dark:text-accent-400 font-medium hover:underline">
            Create one
          </Link>
        </p>
      </div>
...
// Reusable components within the auth module
...
function ErrorMessage({ message }: { message: string }) {
  return (
    <div className="text-sm text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-900/20 px-3 py-2.5 rounded-lg flex items-start gap-2" role="alert">
